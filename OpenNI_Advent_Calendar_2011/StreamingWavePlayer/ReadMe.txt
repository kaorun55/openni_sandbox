========================================================================
    ダイナミック リンク ライブラリ: StreamingWavePlayer 
    プロジェクトの概要
========================================================================

この StreamingWavePlayer DLL は、AppWizard により作成されました。  

このファイルには、StreamingWavePlayer 
アプリケーションを構成する各ファイルの内容の概要が含まれています。

StreamingWavePlayer.vcxproj
...
StreamingWavePlayer.vcxproj.filters
